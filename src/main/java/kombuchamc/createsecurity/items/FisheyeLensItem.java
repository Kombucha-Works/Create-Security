...
public class FisheyeLensItem extends Item {
    ...
    public FisheyeLensItem(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            ...
            addParsedTooltip(tooltip, Text.translatable("tooltip.create-security.fisheye_lens").getString());
        } else {
